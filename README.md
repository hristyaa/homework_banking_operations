...
- Вывод отформатированного списка операций

ВНИМАНИЕ! Для корректной работы файлы с транзакциями должны быть расположены в папке data/.
...
- Функция process_bank_operations принимает список словарей с данными о банковских операциях и 
